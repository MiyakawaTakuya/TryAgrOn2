    ...
    <div class="center">
        <section id="area-1">
            <div>
                ...
                <p>これまでの山口県が培ってきた１次産業を, IT技術を駆使することで未来へとつなげていくファーストステップとなればと思う.</p>
            </div>
            <!--/area1-->
        </section>
        ...
        <div class="bg_test2">
            ...
            <section id="area-4">
                <div>
                    ...
                    <p>メンバーはエンジニアの知見も持ち合わせている３名から構成されています.</p>
                    <p>マーケットリサーチが得意でブロッコリーが大好きな難波. 時々, 狐のように謎めいた振る舞いをする橋口.</p>
